...
'siteconf_info_client_fields' => '<MODIF>Можете да конфигурирате какъв вид информация да се съхранява за клиента. Не се препоръчва да се записват някои данни - като ЕГН. Добре е те да се записват в друга база данни.',
...
'siteconf_input_citizen_number' => '<MODIF>ЕГН',
...
'siteconf_subtitle_case_fields' => '<MODIF>Дело',
'siteconf_subtitle_client_fields' => '<MODIF>Клиент',
'siteconf_subtitle_collab_work' => 'Съвместна работа',
'siteconf_subtitle_followup_fields' => '<MODIF>Следваща информация',
...
// W
'warning_already_installed' => 'вече е инсталирано.',
